...
export class CreateComplaintDto {
    ...
    @ValidateIf((o) => [ComplaintTarget.PROPERTY, ComplaintTarget.LISTING].includes(o.target))
    @IsString()
    ...
    @ValidateIf((o) => [ComplaintTarget.AGENT, ComplaintTarget.PROPERTY, ComplaintTarget.LISTING].includes(o.target))
    @IsMongoId()
    branchId: string;
