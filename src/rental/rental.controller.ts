...
export class RentalController {
    ...
    createOfflinePayment(@Param('id') rentalId: string, @Body() dto: CreateOfflinePaymentDto, @Req() req: any) {
    ...
    verifyOfflinePayment(
        ...
        return this.rentalService.verifyOfflinePayment(rentalId, paymentId, dto, req.user);
    }
    ...
    validateSucceededPayment(
        ...
        return this.rentalService.validateSucceededPayment(rentalId, paymentId, dto, req.user);
    }
    ...
    createMultiMonthPayment(
        ...
        return this.rentalService.createMultiMonthPayment(rentalId, body.monthsCount, body.startFromMonth);
    }
    ...
    createTranchedPayment(
        @Param('id') rentalId: string,
        @Body() body: { trancheAmount: number; trancheNumber: number; forMonth?: Date },
    ) {
    ...
    getRentalPaymentTracking(
        ...
        const parsedMonthsCount = monthsValue && !Number.isNaN(monthsValue) ? monthsValue : undefined;

        const startDateCandidate = startFrom ? new Date(startFrom) : undefined;
        const parsedStartFrom = startDateCandidate && !Number.isNaN(startDateCandidate.getTime())
            ? startDateCandidate
            : undefined;
