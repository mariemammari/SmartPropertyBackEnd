...
export function RequiresBranchIfManagerOrAccountant(validationOptions?: ValidationOptions) {
        ...
        registerDecorator({
            ...
            validator: {
                validate(value: any, args: ValidationArguments) {
                    ...
                    if (obj.role === UserRole.BRANCH_MANAGER || obj.role === UserRole.ACCOUNTANT) {
